...
*/
#define OBJECTIVE_NO_VALUE 0
#define OBJECTIVE_LOW_VALUE 0.1 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
#define OBJECTIVE_MEDIUM_VALUE 0.2 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
#define OBJECTIVE_HIGH_VALUE 0.35 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
#define OBJECTIVE_EXTREME_VALUE 0.7 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
#define OBJECTIVE_ABSOLUTE_VALUE 1.4 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
#define OBJECTIVE_POWER_VALUE 5 * UNIVERSAL_INTEL_POINTS_MULTIPLICATOR * UNIVERSAL_TECH_POINTS_MULTIPLICATOR
//RUCM ENDS tHERE
